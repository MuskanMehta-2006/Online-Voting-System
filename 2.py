...
class LoginPageVoter(tk.Toplevel):
    ...
    def send_vote_confirmation_email():
        ...
        # Prompt the user to enter their email address
            email = simpledialog.askstring("Email Confirmation", "Enter your email address:")
        
        # Your email credentials
            sender_email = "1231@nitkkr.ac.in"
            sender_password = "xyz"  # Update with your email password

        # Email content
            msg = MIMEMultipart()
            msg['From'] = sender_email
            msg['To'] = email
            msg['Subject'] = "Thanks for Voting!"
        ...
        # SMTP connection
            ...
            messagebox.showinfo("Success", "Email confirmation sent successfully!")
        except Exception as e:
            messagebox.showerror("Error", f"Failed to send email confirmation: {e}")
